...
app.get("/cardapio", function(req,res){
  let data = '';
  https.get("http://localhost:80/cardapio",(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/cardapio/:id", function(req,res){
  ...
  let data = '';
  https.get("http://localhost:80/cardapio/"+id,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/cardapioAjax/:id", function(req,res){
  var id = req.params.id;
  let data = '';
  https.get("http://localhost:80/cardapioAjax/"+id,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.post("/cadastrarCardapio",upload.single('imagem'),function(req,res){
  ...
  request({
    method:'post',
    url:'http://localhost:80/cadastrarCardapio', 
    form: cardapio, 
    headers: headersOpt,
    json: true,
  }, 
...
app.post("/alterarCardapio",upload.single('alterarImagem'),function(req,res){
  ...
  request({
    method:'put',
    url:'http://localhost:80/alterarCardapio', 
    form: cardapio, 
    headers: headersOpt,
    json: true,
  }, 
...
app.get("/deletar/:id",function(req,res){
  ...
  request({
    method:'delete',
    url:'http://localhost:80/deletarCardapio', 
    form: {'id':id}, 
    headers: headersOpt,
    json: true,
  }, 
...
app.post("/cadastrarUsuario", function(req,res){
  ...
  request({
    method:'post',
    url:'http://localhost:80/cadastrarUsuario', 
    form:novoUsuario,
    headers: headersOpt,
    json: true,
  },  
...
app.get("/agendamentoAdm", function(req,res){
  let data = '';
  https.get("http://localhost:80/agendamentoAdm",(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/agendamentoAjax/:id", function(req,res){
  var id = req.params.id;
  let data = '';
  https.get("http://localhost:80/agendamentoAjax/"+id,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/usuarioAjax/:cpf", function(req,res){
  ...
  let data = '';
  https.get("http://localhost:80/usuarioAjax/"+cpf,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/emailUser/:email", function(req,res){
  ...
  let data = '';
  https.get("http://localhost:80/emailUser/"+email,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/marmitasAjax/:tipo", function(req,res){
  ...
  let data = '';
  https.get("http://localhost:80/marmitasAjax/"+tipo,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
    }) 
    resp.on('end',()=>{
...
app.get("/valorAjax/:marmitas/turno/:turno/dias/:dias", function(req,res){
  ...
  let data = '';
  https.get("http://localhost:80/valorAjax/"+marmitas,(resp) =>{
    resp.on('data',(chunk) =>{
      data += chunk
     }) 
    resp.on('end',()=>{
...
app.post("/alterarStatus", function(req,res){
  ...
  request({
    method:'put',
    url:'http://localhost:80/alterarStatus', 
    form: altStatus, 
    headers: headersOpt,
    json: true,
  }, 
...
app.get("/dadospedido", function(req,res){
  ...
  console.log(cpf)
  let data = '';
    https.get("http://localhost:80/dadospedido/"+cpf,(resp) =>{
      resp.on('data',(chunk) =>{
        data += chunk
    }) 
    resp.on('end',()=>{
